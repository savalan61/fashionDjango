...
//         title: ReusableText(text: AppText.kTrack, style: appStyle(14, Kolors.kPrimary, FontWeight.w600)),
//       ),
//       body: Container(
//           color: Kolors.kWhite,
//           child: Padding(
...
//                   height: 10.h,
//                 ),
//                 ReusableText(text: "Order Details", style: appStyle(13, Kolors.kDark, FontWeight.w600)),
//                 SizedBox(
//                   height: 20.h,
//                 ),
//
...
//                     children: [
//                       ReusableText(text: status, style: appStyle(12, Kolors.kDark, FontWeight.w500)),
//                       ReusableText(text: date, style: appStyle(10, Kolors.kGray, FontWeight.normal)),
//                       ReusableText(text: address, style: appStyle(10, Kolors.kGray, FontWeight.normal))
//                     ],
//                   ),
//                   const Spacer(),
//                   Icon(
...
//   final IconData icon;
//
//   TrackData({required this.date, required this.status, required this.address, required this.icon});
// }
