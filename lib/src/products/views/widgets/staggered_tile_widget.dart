...
class StaggeredTileWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return wishListState.when(
      data: (wishList) {
        final bool isFavorite = wishList.any(
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            try {
                              ...
                              // Optionally show a message or feedback based on isAdded
                            } catch (e) {
                              // Handle error
                              print('Error toggling wish list: $e');
                            }
                          },
                          child: CircleAvatar(
                            backgroundColor: Kolors.kSecondaryLight,
                            child: Icon(
                              isFavorite ? AntDesign.heart : AntDesign.hearto,
                              color: Kolors.kRed,
                              size: 18,
                            ),
                          ),
